...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = -1034658195L;
    ...
    public final com.sparta.trello.domain.card.entity.QCard card;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.card = inits.isInitialized("card") ? new com.sparta.trello.domain.card.entity.QCard(forProperty("card"), inits.get("card")) : null;
